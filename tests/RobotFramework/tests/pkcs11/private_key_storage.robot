...
Use Private Key in SoftHSM2 using tedge-p11-server
    ...
    # TODO: Set default value device.cryptoki.socket_path /run/tedge-p11-server/tedge-p11-server.sock
    Execute Command    tedge config set device.cryptoki.socket_path /run/tedge-p11-server/tedge-p11-server.sock
